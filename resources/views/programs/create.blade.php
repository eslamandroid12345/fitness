                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name_en" value="{{old('email')}}">
                                </div>
                            </div>
...
{{--                                    <label for="gender">{{__('admin.select_role')}} <span--}}
...
{{--                        <div class="col-md-3">--}}
{{--                            <div class="form-group">--}}
{{--                                <label for="academic_year">{{__('admin_create.image')}} : <span--}}
{{--                                            class="text-danger">*</span></label>--}}
